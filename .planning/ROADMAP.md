...
- [ ] 08-02-PLAN.md -- Portfolio view + audit reconstruct: query_portfolio_view over episodic_memory (no cache, temporal filter, record_type='analysis' only) + reconstruct_audit_trail + audit_reconstruct CLI (SIG-02 + SIG-04 read-side)
...
| 8. Signal and Output | 0/6 | Planned | - |
